...
FILE_ROOT = Path(r"/Users/lucifer/Downloads/DataSet/UA-DETRAC/VOC/score_txt")
FILE_ROOT.parent
# 原始数据集
IMAGE_SET_ROOT = FILE_ROOT.joinpath(r"data_split")  # 图片区分文件的路径
IMAGE_PATH = FILE_ROOT.joinpath(r"images/test")  # 图片的位置
ANNOTATIONS_PATH = FILE_ROOT.joinpath(r"labels/test_xml")  # 数据集标签文件的位置
LABELS_ROOT = FILE_ROOT.joinpath(r"labels/test")  # 进行归一化之后的标签位置
