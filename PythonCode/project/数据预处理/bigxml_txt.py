...
if FLAG == 1:
    ##train
    seq_root = "/Users/lucifer/Downloads/DataSet/UA-DETRAC(车辆检测数据集8250车辆)(1)/Insight-MVT_Annotation_Train/"#图片
    xml_root = "/Users/lucifer/Downloads/DataSet/UA-DETRAC(车辆检测数据集8250车辆)(1)/DETRAC-Train-Annotations-XML/" #原始xml标注
    label_root = "/Users/lucifer/Downloads/DataSet/UA-DETRAC(车辆检测数据集8250车辆)(1)/train_detrac_txt/" #新生成的标签保存目录
else:
    ##test
    seq_root = "/Users/lucifer/Downloads/DataSet/UA-DETRAC(车辆检测数据集8250车辆)(1)/Insight-MVT_Annotation_Test/"#图片
    xml_root = "/Users/lucifer/Downloads/DataSet/UA-DETRAC(车辆检测数据集8250车辆)(1)/DETRAC-Test-Annotations-XML/" #原始xml标注
    label_root = "/Users/lucifer/Downloads/DataSet/UA-DETRAC(车辆检测数据集8250车辆)(1)/test_detrac_txt/" #新生成的标签保存目录
